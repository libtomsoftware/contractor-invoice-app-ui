...
const ServicesListing = (props) => {
    ...
    function formatToCurrency(value) {
        ...
        return currency.symbolInFront ? currency.symbol + valueFormatted : valueFormatted + currency.symbol;
    }

    services = services.map(service => {
        service.discountAmount = calculateDiscountAmount(service.price, service.discountPercentage);
            ...
            <table cellPadding="0" cellSpacing="0">
                ...
                <tbody>
                    ...
                    <tr className="summary summary-subtotal">
                        ...
                        <td className="summary-data">{formatToCurrency(totalDiscountAmount)}</td>
                    </tr>
                    <tr className="summary summary-subtotal">
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
