                                  ...
                                  <div className="card-text">
                                      <fieldset>
                                          {this.companyDetailsFields.map((field, index) => {
                                              return (
                                                  <div
                                                      className={`form-group  ${this.isFieldInvalid('company', field.id) ? 'field-invalid' : 'field-valid'}`}
                                                      key={index}
                                                  >
                                  ...
                                  <div className="card-text">
                                      <fieldset>
                                          {this.clientDetailsFields.map((field, index) => {
                                              return (
                                                  <div
                                                      className={`form-group ${this.isFieldInvalid('client', field.id) ? 'field-invalid' : 'field-valid'}`}
                                                      key={index}
                                                  >
                                                      <label className="control-label" htmlFor={field.id}>
                                                          {field.label}
