class UserAgentUtils {
  constructor() {
    ...
    this.browserDetails = function(uaString) {
      ...
      detected.isAndroidNativeBrowser =
      ...
      // activeX enabled
      try {
        detected.hasActiveXEnabled = Boolean(
      ...
      detected.isIE10modern =
        detected.isIE10 && detected.isOnWin8 && !detected.hasActiveXEnabled;
